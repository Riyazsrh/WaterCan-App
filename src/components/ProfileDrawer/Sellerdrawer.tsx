...
import Buisness from "../../assets/images/BuisnessProfile.png";
import Reports from "../../assets/images/Reports.png";
import { Styles } from "./Sellerdrawer.style";
...
class Sellerdrawer extends React.Component<IProps, MyState2> {
    state = {
        isdrawerOpen: false,
        open: false,
        openPrivacy: false,
...
export default withStyles(Styles)(Sellerdrawer);
